...
import 'package:bloc_learning/dialog/loading_screen_controller.dart';

class LoadingScreen {
  //Singleton Pattern
  LoadingScreen._sharedInstance(); // Internal Constructor
  ...
  void show({
    ...
    if (_loadingScreenController?.updateLoadingScreen(text) ?? false) {
      return;
    } else {
  ...
  void hide() {
    _loadingScreenController?.closeLoadingScreen();
